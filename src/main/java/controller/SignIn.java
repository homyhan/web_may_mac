...
//				----------------
					...
					System.out.println("------------- da luu pbkey lay khi dang nhap----------------");
					System.out.println(user.getPublicKey());
					session.setAttribute("publicKeySession", user.getPublicKey());
					session.setAttribute("emailCustomer", user.getEmail());
					System.out.println("--------------------------");
